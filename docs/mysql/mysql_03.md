...
![img](https://gitee.com/zgf1366/pic_store/raw/master/img/20210218122535.png)

- 右连接查询：查询的结果为两个表匹配到的数据，右表特有的数据，对于左表中不存在的数据使用null填充

![img](https://gitee.com/zgf1366/pic_store/raw/master/img/20210218122545.png)

- 左连接查询：查询的结果为两个表匹配到的数据，左表特有的数据，对于右表中不存在的数据使用null填充

![img](https://gitee.com/zgf1366/pic_store/raw/master/img/20210218122554.png)
...
```sql
select s.name,c.name from students as s inner join classes as c on s.c
```
